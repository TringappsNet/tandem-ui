...
describe('Registration', () => {
  test('render the registration form', () => {
    ...
    expect(
      screen.getByPlaceholderText('Enter your zipcode')
    ).toBeInTheDocument();
    expect(
  ...
  test('should handle successful form submission', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('Enter your address'), {
      target: { value: '7,Street' },
    });
    fireEvent.change(screen.getByPlaceholderText('Enter your mobile number'), {
    ...
    fireEvent.change(screen.getByPlaceholderText('Enter your zipcode'), {
      target: { value: '600000' },
    });
  ...
  test('should handle form submission failure due to invalid invite token', async () => {
    ...
    await (() => {
      expect(
        screen.getByText(/Invalid invite token. Please check and try again./i)
      ).toBeInTheDocument();
    });
  });
});
